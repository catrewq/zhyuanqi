...
import PluginPic from './pluginPic';
// 注释
...
const PIC_LIST = "list";
const PLUGINPIC_LIST = "pluginpic";

export const children: TabRouteConfig[] = (
  [
    { path: PICS_LIST, title: "商品照片展示", element: pics(), isTabRouter: false, className: CLASS_NAME },
    { path: PLUGINPIC_LIST, title: "插件照片展示", element: pluginPic(), isTabRouter: false, className: CLASS_NAME },
  ...
  return (
    <div className="BaseData">
      <Routes>
        ...
        <Route path={PLUGINPIC_LIST} element={pluginPic()} />
      </Routes>
    </div>
  );
}
